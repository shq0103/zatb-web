          ...
          <div class="ac-public-form2">
            <el-form ref="form" label-width="80px">
              ...
              <el-form-item label="活动程度">
                <el-select placeholder="请选择活动程度" style="width: 820px!important;">
              ...
              <el-form-item label="活动要求">
                <el-col :span="11">
                  <el-input placeholder="费用">
                    <template slot="append">元/人</template>
                  </el-input>
                </el-col>
                <el-col class="line" :span="2">-</el-col>
                <el-col :span="11">
                  <el-input placeholder="人数上限">
                    <template slot="append">人</template>
                  </el-input>
                </el-col>
              </el-form-item>
              <el-form-item label="活动说明">
                <el-input placeholder="请简要说明活动内容或需注意事项" type="textarea" minrows="6"></el-input>
              </el-form-item>
